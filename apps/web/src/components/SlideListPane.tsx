      ...
      {slides.map((slide, idx) => (
        <div
          ...
          className={cn(
            ...
            slide.id === currentId
              ? 'border-[var(--system-blue)] ring-2 ring-[rgba(94,106,210,0.35)]'
              : 'border-[var(--rule)] hover:border-[rgba(94,106,210,0.6)]',
            overIndex === idx && dragIndex !== null && dragIndex !== idx ? 'ring-2 ring-[rgba(94,106,210,0.5)]' : '',
