...
const guide: typeof zh = {
  ...
  flow: {
    ...
    steps: [
      { title: 'Let AI generate HTML', desc: 'Send one prompt to any AI and get a ready-made HTML deck with animations' },
      { title: 'Pick an editor', desc: 'HTML Deck keeps animations, PPT Editor paginates — choose what you need' },
      { title: 'Export to present', desc: 'HTML Deck exports HTML, PPT Editor exports PPTX / PDF, all local' },
    ],
  },
  generate: {
    title: 'Step 1 · Let AI generate HTML',
    intro: "Can't build it yourself? No problem. Copy the prompt below into any AI and it hands you a ready-made HTML deck file you can come back and edit. Already have AI-made HTML? Just open it, common pagination (div.slide, top-level <section>, .page) is auto-detected, and unpaginated HTML still opens as one page.",
    ...
    steps: [
      ...
      { title: 'Come back and open it', desc: 'Go back to the home page, click upload and pick "HTML Deck" or "PPT Editor", or just drag the file to the matching zone.' },
    ],
  ...
  edit: {
    title: 'Step 2 · Pick an editor',
    intro: 'Choose an editor when you open the file. Each has its strengths — HTML Deck to keep animations, PPT Editor for paginated fine-tuning.',
    htmlDeck: {
      name: 'HTML Deck',
      pill: 'main',
      desc: 'Keeps animations and interactions; edit text and position in place; exports HTML',
      abilities: [
    ...
    pptEditor: {
      name: 'PPT Editor',
      desc: 'Paginated fine-tuning, edit like a PPT, export to PPTX / PDF',
      abilities: [
      ...
      cta: 'Open a file and start editing',
    },
  },
  export: {
    title: 'Step 3 · Export to present',
    intro: 'Happy with it? Export based on the editor you used. Two export paths, one per editor.',
    htmlExport: {
      name: 'HTML Deck → HTML',
      notes: [
        'Tweaks are baked in as inline styles; original scripts and structure stay intact, animations keep running, interactions keep working.',
        'Share with a single link — no install, no conversion, just open in a browser to present.',
        'Everything happens on your computer, nothing uploaded.',
      ],
    },
    pptExport: {
      name: 'PPT Editor → PPTX / PDF',
      notes: [
